...
export class LoginComponent implements OnInit {
    constructor( private snack:MatSnackBar, private logger: NGXLogger,
...
if(data!=null){
  ...
  this.loginService.login(this.user).subscribe((data:any)=>{
    ...
    console.log(this.loginService.getRole()+"------"+this.loginService.getToken()+"------")

if(data.status=='UNAUTHORIZED'){
  this.snack.open("Invalid"+" username :" +this.user.username+"","",{
    duration:3000
 })
  return ;
}
